...
a = np.random.randint(low=50, high=60, size=(2, 3, 5))
...
#nope, cause they have different shapes. 

#9. Transpose b so that 
#it has the same structure of a (i.e. become a 2x3x5 array).
...
d = a + c
print(d)
#cause they are same size

#11. Print a and d. Notice the difference and 
#relation of the two array in terms of the values? Explain.
...
"""
#16. Populate the values in f. For each value in d, if it's 
larger than d_min but smaller than d_mean, assign 25 to the corresponding 
value in f.
...
_1_ = (d > d_min) & (d < d_mean)
f[_1_] = 25

_2_ = (d > d_mean) & (d < d_max)
